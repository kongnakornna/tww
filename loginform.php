...
<div id="wrapper">
   <?php include('_header.inc.php'); ?>
    ...
    <div id="pagenavi"><a href="mainpage.php">หน้าแรก</a> &raquo;&nbsp;เข้าสู่ระบบ</div>
    
    <div id="topicstyle1">เข้าสู่ระบบ</div>
    
    <div id="contentwide">
	    <form method="post" action="loginform_exec.php" name="frmLogin" id="frmLogin">
    อีเมล์ผู้ใช้งาน<br />
    <input name="uname" id="uname" type="text" maxlength="35" class="contactbox" />&nbsp;<font color="#ff0000">*</font><br /><br />
    
    รหัสผ่านผู้ใช้งาน<br />
    <input name="pname" id="pname" type="password" maxlength="35" class="contactbox" />&nbsp;<font color="#ff0000">*</font><br /><br />
    
    <input name="btSubmit" id="btSubmit" type="submit" class="submitbox" value="เข้าสู่ระบบ" />
    </form>
