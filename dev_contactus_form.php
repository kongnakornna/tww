...
<div id="wrapper">
   <?php include('_headerdev.inc.php'); ?>
    ...
    <div id="pagenavi"><a href="mainpage.php">หน้าแรก</a> &raquo;&nbsp;ติดต่อทีมผู้ดูแลระบบ EasyCard</div>
    
    <div id="topicstyle1">ติดต่อทีมผู้ดูแลระบบ EasyCard</div>
    
    <div id="contentwide">
	    <form method="post" action="dev_contactus_exec.php" name="frmContact" id="frmContact">
