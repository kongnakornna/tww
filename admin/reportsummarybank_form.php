...
$member = new member();
$DateNow = date ("j M Y");
$banklist = $bank->getlist('','เลือกทั้งหมด');
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="reportsummarybank_exec.php" method="post" name="frmreport" id="frmreport">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการรายงานสรุปยอดต่าง ๆ - สรุปยอดผลตอบแทนแยกตามรหัสลูกค้า แสดงข้อมูลธนาคาร</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                ...
                <td class="linemenu"><select name="bank" id="bank" style="width:300px;"><?php echo $banklist;?></select></td>
               </tr>
              <tr>
