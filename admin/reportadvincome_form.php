...
$member = new member();
$DateNow = date ("j M Y");
$servicelist = $content->getsubcategoriedd('3','');
$memberlist = $member->getmemberlist('');
$typelist = $member->getmembertypedd('');
?>
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="reportadvincome_exec.php" method="post" name="frmreport" id="frmreport">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการรายงานสรุปยอดต่าง ๆ - ผลตอบแทนแบบละเอียด แยกตามรหัสลูกค้า</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td align="right" valign="middle" class="barG">ประเภทลูกค้า :&nbsp;</td>
                <td class="linemenu"><select name="type" id="type" style="width:300px;"><?php echo $typelist;?></select></td>
               </tr>
              <tr>
                <td align="right" valign="middle" class="barG">รหัสลูกค้า :&nbsp;</td>
                <td class="linemenu"><select name="memcode" id="memcode" style="width:300px;"><?php echo $memberlist;?></select></td>
               </tr>
              <tr>
                <td align="right" valign="middle" class="barG">บริการ :&nbsp;</td>
                <td class="linemenu"><select name="service" id="service" style="width:300px;"><?php echo $servicelist;?></select></td>
               </tr>
