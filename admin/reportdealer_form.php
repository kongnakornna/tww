  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="reportdealer_exec.php" method="post" name="frmreport" id="frmreport">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                ...
                <td class="linemenu"><input type="text" name="user" id="user" style="width:300px;" readonly=readonly />&nbsp;<input type="button" value="::" name="btnMember" id="btnMember" onclick="openUserform();" /></td>
               </tr>
              <tr>
