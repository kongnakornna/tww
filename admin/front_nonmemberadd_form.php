    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        <td height="580" align="center" valign="top" >
		 ...
		 <form action="front_nonmemberadd_exec.php" method="post" name="frmAddMember" id="frmAddMember">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">ลงทะเบียนเครื่อง Other</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                ...
                <td width="80%" class="linemenu"><input type="text" name="imeino" id="imeino" maxlength="20" style="width:300px;" /></td>
              </tr>
                <td align="right" valign="middle" class="barG">ยี่ห้อ :&nbsp;</td>
              ...
              <tr>
                <td align="right" valign="middle" class="barG">รหัส TWZpay :&nbsp;</td>
                <td class="linemenu"><input type="text" name="paymentcardno" id="paymentcardno" maxlength="35" style="width:300px;" />*</td>
              </tr>
              <tr>
