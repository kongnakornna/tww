...
// Include Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="' +cssDir+ 'wstyles.css">\n');
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      window.open(popupsDir + 'insert_image.php?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=1,resizable=1,width=700,height=600');
	  }
	    ...
	    window.open(popupsDir + 'about.html','popup','location=0,status=0,scrollbars=0,resizable=0,width=340,height=130');
	  }
