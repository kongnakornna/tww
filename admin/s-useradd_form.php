  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="s-useradd_exec.php" method="post" name="frmAddUserM" id="frmAddUserM">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ลงทะเบียนให้สมาชิก-เพิ่มรายชื่อ SD-Code</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                ...
                <td width="35%" class="linemenu"><input type="text" name="uname" id="uname" value="" maxlength="35" style="width:300px;" />*</td>
                <td width="50%" class="linemenu" colspan="2">&nbsp;</td>
             </tr>
			 <tr>
                <td width="15%" align="right" valign="middle" class="barG">ชื่อผู้ขาย :&nbsp;</td>
                <td width="35%" class="linemenu"><input type="text" name="shoptitle" id="shoptitle" value="" style="width:300px;" /></td>
                <td width="15%" align="right" valign="middle" class="barG">รหัสผ่าน :&nbsp;</td>
                <td width="35%" class="linemenu"><input type="password" name="pname" id="pname" value="" maxlength="15" style="width:300px;" /></td>
              </tr>
              <tr>
