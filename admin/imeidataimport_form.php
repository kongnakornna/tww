  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="imeidataimport_exec.php" method="post" enctype="multipart/form-data" name="frmImportImeiData" id="frmImportImeiData">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการรายการ Imei - Import Imei Data</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">รหัสประเภท :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="text" name="type" id="type" maxlength="35" style="width:300px;" />*</td>
              </tr>
              <tr>
