...
if ($param_keyword=='') {
  ...
  $SQLSearch = " and u_fullname like '%".$param_keyword."%'";
}
$SqlComCheck = "select * from tbl_username where u_group='U' and u_frontside='N' $SQLSearch order by u_id";
...
$SqlCheck = "select * from tbl_username where u_group='U' and u_frontside='N' $SQLSearch order by u_id desc limit $min,$maxrec";
...
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
		...
		if ($db_username=='admin') {
		    $UserList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$db_username."</td><td class=\"tblist\">".$db_fullname."</td><td class=\"txt2 tblist\">".$db_email."</td><td class=\"txt1 tblist\"><a href=\"useredit_form.php?id=$db_id\"><img src=\"images/edit.png\" width=\"16\" height=\"16\" border=\"0\" title=\"edit record\" /></a></td></tr>";
		}else{
		    $UserList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$db_username."</td><td class=\"tblist\">".$db_fullname."</td><td class=\"txt2 tblist\">".$db_email."</td><td class=\"txt1 tblist\"><a href=\"useredit_form.php?id=$db_id\"><img src=\"images/edit.png\" width=\"16\" height=\"16\" border=\"0\" title=\"edit record\" /></a>&nbsp;&nbsp;<a href=\"userdel_exec.php?id=$db_id\"  onclick=\"return confirmLink(this, 'ลบข้อมูล?')\"><img src=\"images/delete.png\" width=\"16\" height=\"16\" border=\"0\" title=\"delete record\"/></a></td></tr>";
		}
	}
}
unset($RowCheck);
            ...
            <td>&nbsp;</td>
              ...
              <tr>
                <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <form action="user_view.php" method="post" name="frmsearchuser" id="frmsearchuser">
                  ...
                  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1">
                    <tr>
                      ...
                      <td width="20%" bgcolor="#F5F5F5" class="txt1 tblist tablehead">Username</td>
