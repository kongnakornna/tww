...
$SqlCheck = "select * from tbl_phone_brand where p_id='".$param_id."' order by p_id";
...
$(document).ready(function() {
	$("#btnBack").click(function(){
		document.location.href="phonebrand_view.php?page=1";
    }); 
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="phonebrandedit_exec.php" method="post" name="frmAddPhoneBrand" id="frmAddPhoneBrand">
		<input type="hidden" id="id" name="id" value="<?php echo $param_id;?>" />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ใช้งาน - แก้ไขยี่ห้อมือถือ</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                <tr>
                <td width="15%" align="right" valign="middle" class="barG">ชื่อยี่ห้อมือถือ :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="text" name="title" id="title" maxlength="75" style="width:300px;" value="<?php echo $db_title;?>" />*</td>
              </tr>
