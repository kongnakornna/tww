  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="emailconfig_exec.php" method="post" name="frmconfigemail" id="frmconfigemail">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการข้อมูลทั่วไป - Add Email ติดต่อบริการ</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">อีเมล์ :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="text" name="title" id="title" maxlength="100" style="width:300px;" value="<?php echo stripslashes($msgdata[0]['m_message']);?>" />*</td>
              </tr>
              </table></td></tr>
              <tr>
                <td><img src="images/spacer.gif" width="1" height="3" /></td>
