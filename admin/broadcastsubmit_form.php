...
$(document).ready(function() {
	$("#btnBack").click(function(){
		document.location.href="broadcast_view.php";
    }); 
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="broadcastadd_exec.php" method="post" name="frmBroadcast" id="frmBroadcast">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">แจ้งข่าวสมาชิก easy Card</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
               <tr>
                <td align="right" valign="middle" class="barG">วิธีแจ้งข่าว&nbsp;</td>
                <td class="linemenu"><select name="type" id="type" style="width:200px;">
                       <option value="01">ทั้งหมด</option>
                       <option value="02">เลือกสมาชิก</option>
                      </select>
				</td>
			  </tr>
              <tr>
                <td align="right" valign="middle" class="barG">Email สมาชิก&nbsp;</td>
                <td class="linemenu" valign="middle"><input type="text" name="email" id="email" maxlength="30" style="width:300px;" /></td>
              </tr>
              <tr>
                <td align="right" valign="middle" class="barG">ข้อความ</td>
                <td class="linemenu" rowspan=4><input type="text" name="message" id="message" maxlength="1200" style="width:1200px;" /></td>
              </tr>
              </table></td></tr>
              <tr>
                <td><img src="images/spacer.gif" width="1" height="3" /></td>
