...
$dcode_array = $member->getallmemberdcode();
...
if ($RowsCheck>0) {
	...
	for ($t=0;$t<$RowsCheck;$t++) {
		 ...
		 $db_price = $db_total - $db_charge;
                 ...
                 if(!array_key_exists($db_email,$dcode_array)) { 
                 $iNum++;
                 $custname = $member->getnamefromcode($db_pncode);
		 ...
		 $granddiscount = $granddiscount + $db_discount;
                 $mydcode = $member->getdcodefromemail($db_email);
                 if ($mydcode != '') {
                     $mymember = $member->getmemberfromdcode_u($mydcode);
                 } 
         ...
         $DataList .= "<tr bgcolor=\"".$iColor."\"><td align=\"right\" class=\"tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$db_date."</td><td align=\"center\" class=\"tblist\">".$db_time."</td><td align=\"center\" class=\"tblist\">".$custcode."</td><td align=\"center\" class=\"tblist\">".$mymember."</td><td align=\"center\" class=\"tblist\">".$custname."</td><td align=\"center\" class=\"tblist\">".$codename."</td><td align=\"left\" class=\"tblist\">".$db_msisdn."</td><td align=\"center\" class=\"tblist\">".$db_price."</td><td align=\"center\" class=\"tblist\">".$db_charge."</td><td align=\"center\" class=\"tblist\">".$db_total."</td><td align=\"center\" class=\"tblist\">".$db_discount."</strong></td></tr>";
	}
        }
}
$DataList .= "<tr bgcolor=\"#ffffff\"><td colspan=\"8\" align=\"right\" class=\"tblist\">ยอดรวม : </td><td align=\"center\" class=\"tblist\">".number_format($grandprice,2,'.',',')."</td><td align=\"center\" class=\"tblist\">".number_format($grandcharge,2,'.',',')."</td><td align=\"center\" class=\"tblist\">".number_format($grandtotal,2,'.',',')."</td><td align=\"center\" class=\"tblist\"><strong>".number_format($granddiscount,2,'.',',')."</strong></td></tr>";
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">รายงานผลตอบแทนของงสมาชิกกภายใต้ตัวแทน</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
	          ...
	          <tr>
  		      ...
  		      <td width="6%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>วันที่ทำรายการ</strong></td>
	              <td width="4%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>เวลา</strong></td>
					  ...
					  <td width="8%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>รหัสสมาชิก  Dcode</strong></td>
