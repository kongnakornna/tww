...
$(document).ready(function() {
	$("#btnBack").click(function(){
		document.location.href="phonemodel_view.php?page=1";
    }); 
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="phonemodeladd_exec.php" method="post" name="frmAddPhoneModel" id="frmAddPhoneModel">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ใช้งาน - เพิ่มรุ่นมือถือ</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                ...
                <td width="35%" class="linemenu"><input type="text" name="title" id="title" maxlength="75" style="width:300px;" />*</td>
              </tr>
