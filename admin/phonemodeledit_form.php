...
$SqlCheck = "select * from tbl_phone_model where m_id='".$param_id."' order by m_id";
...
unset($RowCheck);
$brandlist = $product->getbrandlist($db_brand);
?>
...
$(document).ready(function() {
	$("#btnBack").click(function(){
		document.location.href="phonemodel_view.php?page=1&brand=<?php echo $db_brand;?>";
    }); 
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="phonemodeledit_exec.php" method="post" name="frmAddPhoneModel" id="frmAddPhoneModel">
		<input type="hidden" id="id" name="id" value="<?php echo $param_id;?>" />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ใช้งาน - แก้ไขรุ่นมือถือ</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                <tr>
                <td width="15%" align="right" valign="middle" class="barG">ยี่ห้อมือถือ :&nbsp;</td>
                <td width="35%" class="linemenu"><select name="brand" id="brand" style="width:300px;"><?php echo $brandlist;?></select>*</td>
                <td width="15%" align="right" valign="middle" class="barG">ชื่อรุ่นมือถือ :&nbsp;</td>
                <td width="35%" class="linemenu"><input type="text" name="title" id="title" maxlength="75" value="<?php echo $db_title;?>" style="width:300px;" />*</td>
              </tr>
