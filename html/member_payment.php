...
$paymentcode = $member->getpaymentcard($_SESSION['TWEmail']);
?>
...
<div id="wrapper">
   <?php include('_header.inc.php'); ?>
    ...
    <div id="pagenavi"><a href="mainpage.php">หน้าแรก</a> &raquo;&nbsp;ดูรหัสเติมเงิน</div>
    
    <div id="topicstyle1">ดูรหัสเติมเงิน</div>
