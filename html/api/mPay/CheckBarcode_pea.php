...
$modulename='CheckBarcode_pea.php[MPAY]';
#$refkey = $param_refid;
...
if ($param_barcode1=='' || $param_barcode2=='' || $param_email =='') {
	...
	$dataarray = array("result"=>"FAIL","result_desc"=>$String->tis2utf8($msg),"refid"=>"");
        ...
        if ($result_array['status'] == 'ok') {
            ...
            if ($result_array['status'] == 'ok') {
                ...
                $param_price = $amount;
                $sercharge = $fee;
                $resultpayment = $payment->insertipps($partnercode,$param_code,$servicename,'I',$param_price,$sercharge,$totalprice,$refkey,$ref1,$ref2,$ref3,$ref4,'N',$param_email,$param_email,'',$param_msisdn,'0'); 
                $dataarray = array("result"=>"OK","result_desc"=>"","refcode"=>$refkey,"price"=>$param_price,"sercharge"=>$sercharge,"totalprice"=>$totalprice,"ref1"=>$ref1,"ref2"=>$ref2,"ref3"=>$ref3,"ref4"=>$ref4,"ref5"=>$ref5,"ref6"=>$ref6,"duedate"=>$duedate,"duedateflag"=>$duedateFlag);
           }
           else{
