...
$folderarray = array ("àµÔÁà§Ô¹Á×Í¶×Í","ªÓÃÐºÔÅÁ×Í¶×Í ÃÒÂà´×Í¹","ªÓÃÐ¤èÒºÃÔ¡ÒÃÍÔ¹àµÍÃìà¹çµ","ªÓÃÐ¤èÒ¹éÓ»ÃÐ»Ò ä¿¿éÒ â·ÃÈÑ¾·ìºéÒ¹","ªÓÃÐ¤èÒºÑµÃà¤Ã´Ôµ");
$folderimage = array ("m_mobile_topup.png","m_mobile_phone.png","m_adsl.png","m_public_utilities.png","m_credit.png");
$folderindex = array ("1","2","4","3","5");
for ($num=0;$num<count($folderindex);$num++) {
	$cdata = $eservice->getdata($folderindex[$num]);
