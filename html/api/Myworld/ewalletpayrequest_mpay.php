            ...
            $result_array = $ipps->extractresult($resstr);
                 if ($result_array['status'] == '01' || $result_array['status'] == '00')  // Status success 
                 {
                      ...
                      if ($result_array['status']  == '01')  
                       $dataarray = array("result"=>"OK","result_desc"=>"","refcode"=>$refcode,"txnid"=>$result_array['txnid'],"price"=>$param_price,"sercharge"=>$sercharge,"totalprice"=>$totalprice,"otp"=>""); 
                       else
                       $dataarray = array("result"=>"OKNOOTP","result_desc"=>"","refcode"=>$refcode,"txnid"=>$result_array['txnid'],"price"=>$param_price,"sercharge"=>$sercharge,"totalprice"=>$totalprice,"otp"=>""); 
                 }
                 else
                 {
