...
Class WebClass {
	...
	function paging($totalrecord,$recordperpage,$nowpage='',$url='') {
		 ...
		 if ($url=='') {
			$data .= "<a href=\"?page=1\"><<</a>&nbsp;&nbsp;<a href=\"?page=".$prevpage."\"><</a>&nbsp;&nbsp;" . $pageinput . "&nbsp;ถึง&nbsp;".$totalpage."&nbsp;<a href=\"?page=".$nextpage."\">></a>&nbsp;&nbsp;<a href=\"?page=".$totalpage."\">>></a>";
		 }else{
			$data .= "<a href=\"?page=1&".$url."\"><<</a>&nbsp;&nbsp;<a href=\"?page=".$prevpage."&".$url."\"><</a>&nbsp;&nbsp;" . $pageinput . "&nbsp;ถึง&nbsp;".$totalpage."&nbsp;<a href=\"?page=".$nextpage."&".$url."\">></a>&nbsp;&nbsp;<a href=\"?page=".$totalpage."&".$url."\">>></a>";
		 }
