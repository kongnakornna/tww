...
<div id="wrapper">
   <?php include('_header.inc.php'); ?>
    ...
    <div id="pagenavi"><a href="mainpage.php">หน้าแรก</a> &raquo;&nbsp;<?php echo $msgtitle;?></div>
    
    <div id="topicstyle1"><?php echo $msgtitle;?></div>
    
    <div id="contentwide"><br clear="all" /><?php echo $msgdetail;?></div>
