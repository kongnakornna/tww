...
$dataList = "ÃÒÂª×èÍ·Õè·Ó¡ÒÃÊÁÑ¤ÃÊÁÒªÔ¡ â´Â D-Code\n\n";
$dataList .= "ÇÑ¹·Õè : ".$period."\n";
$dataList .= "#,ª×èÍÊÁÒªÔ¡,¨Ó¹Ç¹à§Ô¹\n";

$SqlCheck = "select * from tbl_member where (m_adddate>='".$startdate." 00:00:00' and m_adddate<='".$enddate." 59:59:59') and m_dcode='".$_SESSION['TWZUsername']."' and p_type='A' and p_status='1' order by m_adddate";
