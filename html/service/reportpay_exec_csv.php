...
$SqlCheck = "select * from tbl_member,tbl_payment where (m_email=p_email) and (m_email=p_email) and (m_adddate>='".$startdate." 00:00:00' and m_adddate<='".$enddate." 59:59:59') and m_saleid='".$_SESSION['TWZUsername']."' and p_type='A' and p_status='1' order by m_adddate";
