...
for ($c=0;$c<$catdata_count;$c++) {
	 ...
	 $freeapplist = $app->getdata ('F',$cat_id,$param_sort);
	 ...
	 if ($freeapplistrows>0) {
		 ...
		 $dlist .= "<br clear=\"all\" /><div style=\"float:right; text-align:right;\"><a href=\"productbycategorie.php?cat=".$cat_id."\">[ดูเพิ่มเติม]</a></div><br clear=\"all\" /><img src=\"images/blank.gif\" width=\"1\" height=\"3\"><br />\n\n";
	 }
}
