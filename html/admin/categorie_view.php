...
if ($param_keyword=='') {
  ...
  $SQLSearch = " and c_title like '%".$param_keyword."%'";
}
$SqlComCheck = "select * from tbl_categorie where 1 $SQLSearch order by c_id";
...
$SqlCheck = "select * from tbl_categorie where 1 $SQLSearch order by c_id desc limit $min,$maxrec";
...
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
	     ...
	     $DataList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"left\" class=\"tblist\">".$db_title."</td><td align=\"center\" class=\"tblist\"><a href=\"categorieedit_form.php?id=".$db_id."\"><img src=\"images/edit.png\" width=\"16\" height=\"16\" border=\"0\" title=\"edit record\" /></a>&nbsp;&nbsp;<a href=\"categoriedel_exec.php?id=".$db_id."\" onclick=\"return confirmLink(this, 'ลบข้อมูล?')\"><img src=\"images/delete.png\" width=\"16\" height=\"16\" border=\"0\" title=\"delete record\"/></a></td></tr>";
	}
}
unset($RowCheck);
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">แนะนำร้านค้าที่ใช้ EasyCard ได้-แสดงรายการประเภทร้านค้า</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
              <tr>
                <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top" class="txtsg">ค้นหาชื่อประเภทร้านค้า :</td>
                      <td align="left" valign="top" class="txtsg">&nbsp;</td>
                  </tr>
                  <tr>
                    <form action="categorie_view.php" method="post" name="frmsearchuser" id="frmsearchuser">
                  ...
                  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1">
                    <tr>
                      ...
                      <td bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>ชื่อประเภทร้านค้า</strong></td>
