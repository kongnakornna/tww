  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="message_exec.php" method="post" name="frmmessage" id="frmmessage">
		<input type="hidden" id="code" name="code" value="<?php echo $param_code;?>" />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการข้อมูลกลาง - <?php echo $msgdata[0]['m_title'];?></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">หัวข้อ :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="text" name="title" id="title" maxlength="100" style="width:300px;" value="<?php echo stripslashes($msgdata[0]['m_title']);?>" />*</td>
              </tr>
              <tr>
                <td align="right" valign="top" class="barG">ข้อความ :&nbsp;</td>
                <td class="linemenu"><textarea rows="16" id="msg" name="msg" style="width:550px;"><?php echo stripslashes($msgdata[0]['m_message']);?></textarea></td>
              </tr>
              </table></td></tr>
              <tr>
                <td><img src="images/spacer.gif" width="1" height="3" /></td>
