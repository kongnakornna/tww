...
$SqlComCheck = "select * from tbl_username where u_group='U' and u_frontside='Y' $SQLSearch order by u_id";
...
$SqlCheck = "select * from tbl_username where u_group='U' and u_frontside='Y' $SQLSearch order by u_id desc limit $min,$maxrec";
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">แสดงรายชื่อผู้ใช้งาน ระบบเติมเงิน</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
              <tr>
                <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <form action="userpayment_view.php" method="post" name="frmsearchuser" id="frmsearchuser">
