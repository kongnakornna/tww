...
$SqlCheck = "select * from tbl_subcategorie where s_catid='3' order by s_id";
$ResultCheck = $DatabaseClass->DataExecute($SqlCheck);
$RowsCheck = $DatabaseClass->DBNumRows($ResultCheck);
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
		 $RowCheck = $DatabaseClass->DBfetch_array($ResultCheck,$t);
		 $db_id = $RowCheck['s_serviceid'];
		 $db_title = stripslashes($RowCheck['s_title']);
         
		 $productlist .= "<option value=\"".$db_id."\">".$db_title."</option>\n";
	}
}
?>
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="reportservice_exec.php" method="post" name="frmreport" id="frmreport">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการรายงาน - ยอดการใช้บริการต่าง ๆ</td>
          </tr>
          <tr>
