...
$(document).ready(function() {
	$("#btnBack").click(function(){
		document.location.href="m-user_view.php?page=1";
    }); 
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="m-user_import_exec.php" method="post" enctype="multipart/form-data" name="frmImportSData" id="frmImportSData">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ลงทะเบียนให้สมาชิก-นำเข้ารายชื่อ D-Code</td>
          </tr>
          <tr>
