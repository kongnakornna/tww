...
function openUserform() {
    window.open ("usershow.php?type=S","_blank","width=750,height=500,left=120,top=50");
}
//-->
</SCRIPT>
</head>
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="m-reportpay_exec.php" method="post" name="frmreport" id="frmreport">
		<input type="hidden" name="type" id="type" value="S" />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการรายงาน - รายงานยอดสมัครสมาชิกโดย S-Code</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td align="right" valign="middle" class="barG">รายชื่อ S-Code :&nbsp;</td>
