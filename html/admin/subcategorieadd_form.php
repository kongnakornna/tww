  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="subcategorieadd_exec.php" method="post" enctype="multipart/form-data" name="frmAddCategorie" id="frmAddCategorie">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">แนะนำร้านค้า - เพิ่มรายการประเภทบริการรอง</td>
          </tr>
          <tr>
