    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="thubedit_exec.php" method="post" name="frmthubupdate" id="frmthubupdate">
          ...
          <tr>
            <td class="txttopicpage">จัดการข้อมูลกลาง - แก้ไขรายการ TWZpay Code</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">รหัสสมาชิก :&nbsp;</td>
              ...
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">รหัส TWZpay :&nbsp;</td>
