...
if ($RowsGroup>0) {
	for ($t=0;$t<$RowsGroup;$t++) {
		 ...
		 $service_array[$t] = $RowGroup['servicecode'];
	}
}
	...
	if ($RowsCheck>0) {
		for ($t=0;$t<$RowsCheck;$t++) {
			...
			$data_com = "";
			 ...
			 $DataList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$service_code."</td><td align=\"center\" class=\"tblist\">".$service_name."</td><td align=\"center\" class=\"tblist\">".$db_paydate."</td><td class=\"txt1 tblist\">".$member_name."</td><td align=\"center\" class=\"tblist\">".$member_type."</td><td align=\"center\" class=\"tblist\">".$db_productamt."</td><td align=\"center\" class=\"tblist\">".$db_inccustfee."</td><td align=\"center\" class=\"tblist\">".$db_totalamt."</td><td align=\"center\" class=\"tblist\">".$Data_TP."</td><td align=\"center\" class=\"tblist\">".$Data_TPF."</td><td align=\"center\" class=\"tblist\">".$Data_TPA."</td><td align=\"center\" class=\"tblist\">".$Data_TPFA."</td><td align=\"center\" class=\"tblist\">".$Data_TWZ."</td></tr>";

		}
	}
	unset($RowCheck);
	$DataList .= "<tr bgcolor=\"#ffffff\"><td colspan=\"8\" align=\"right\" class=\"tblist\"><b>Total :</b></td><td class=\"txt1 tblist\">".$gtotal."</td><td align=\"center\" class=\"tblist\">".$total_tp."</td><td align=\"center\" class=\"tblist\">".$total_tpf."</td><td align=\"center\" class=\"tblist\">".$total_tpa."</td><td align=\"center\" class=\"tblist\">".$total_tpfa."</td><td align=\"center\" class=\"tblist\">".$total_twz."</td></tr>";
    $DataList .= "<tr><td colspan=\"14\" height=\"15\">&nbsp;</td></tr>";
}
