...
$SqlComCheck = "select * from tbl_username where u_group='M' and u_status='1' $SQLSearch order by u_id";
...
$SqlCheck = "select * from tbl_username where u_group='M' and u_status='1' $SQLSearch order by u_id desc limit $min,$maxrec";
...
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
		 ...
		 $totalmember = $member->totalmemberbydealer($db_username);

		 if ($totalmember > 0) {
             $UserList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$db_code."</td><td align=\"center\" class=\"tblist\">".$db_username."</td><td align=\"left\" class=\"tblist\">".$db_fullname."</td><td align=\"center\" class=\"tblist\">".$db_shopprovince."</td><td align=\"center\" class=\"tblist\">".$db_phone."</td><td align=\"center\" class=\"tblist\">".$StatusText."</td><td align=\"center\" class=\"tblist\"><a href=\"member_view.php?type=M&code=".$db_username."\">".$totalmember."</a></td><td class=\"txt1 tblist\"><a href=\"m-useredit_form.php?id=$db_id\"><img src=\"images/edit.png\" width=\"16\" height=\"16\" border=\"0\" title=\"edit record\" /></a></td></tr>";
		 }else{
             $UserList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$db_code."</td><td align=\"center\" class=\"tblist\">".$db_username."</td><td align=\"left\" class=\"tblist\">".$db_fullname."</td><td align=\"center\" class=\"tblist\">".$db_shopprovince."</td><td align=\"center\" class=\"tblist\">".$db_phone."</td><td align=\"center\" class=\"tblist\"><a href=\"member_view.php?type=M&code=".$db_username."\">".$totalmember."</a></td><td align=\"center\" class=\"tblist\">".$StatusText."</td><td class=\"txt1 tblist\"><a href=\"m-useredit_form.php?id=$db_id\"><img src=\"images/edit.png\" width=\"16\" height=\"16\" border=\"0\" title=\"edit record\" /></a>&nbsp;&nbsp;<a href=\"m-userdel_exec.php?id=$db_id\"  onclick=\"return confirmLink(this, 'ลบข้อมูล?')\"><img src=\"images/delete.png\" width=\"16\" height=\"16\" border=\"0\" title=\"delete record\"/></a></td></tr>";
		 }
	}
}
unset($RowCheck);
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ลงทะเบียนให้สมาชิก-แสดงรายชื่อ D-Code</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
              <tr>
                <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top" class="txtsg">ค้นหาชื่อตัวแทนจำหน่าย :</td>
                      <td align="left" valign="top" class="txtsg">&nbsp;</td>
                  </tr>
                  <tr>
                    <form action="m-user_view.php" method="post" name="frmsearchuser" id="frmsearchuser">
                  ...
                  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1">
                    <tr>
                      ...
                      <td width="10%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>รหัสตัวแทน</strong></td>
                      <td width="10%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>ชื่อสำหรับใช้งาน</strong></td>
                      <td bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>ชื่อตัวแทน</strong></td>
                      <td width="18%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>จังหวัด</strong></td>
                      <td width="15%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>เบอร์โทรศัพท์</strong></td>
