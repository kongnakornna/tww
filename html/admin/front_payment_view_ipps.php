    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        <td height="580" align="center" valign="top" >
		 ...
		 <form action="front_payment_exec_ipps.php" method="post" name="frmPaymentView" id="frmPaymentView">
		 <input type="hidden" name="cardcode" id="cardcode" value="<?php echo $param_cardcode;?>" />
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td width="20%" align="right" valign="middle" class="barG">ชื่อสมาชิก :&nbsp;</td>
			  ...
			  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
				    <td align="left"><button name="btnBack" id="btnBack" type="button" class="back">กลับไป</button>&nbsp;&nbsp;<button name="btnCancel" id="btnCancel" type="button" class="add2">ยกเลิก</button></td>
                    <td align="right"><input type="submit" name="btnSubmit" id="btnSubmit" value="ยืนยัน" />
					</td>
                  </tr>
                </table>
