...
$productlist = "<option value=\"\"></option>\n";
$SqlCheck = "select m_service from tbl_mpayreport group by m_service order by m_service";
$ResultCheck = $DatabaseClass->DataExecute($SqlCheck);
$RowsCheck = $DatabaseClass->DBNumRows($ResultCheck);
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
		 $RowCheck = $DatabaseClass->DBfetch_array($ResultCheck,$t);
		 $db_service = stripslashes(trim($RowCheck['m_service']));
         
		 $productlist .= "<option value=\"".$db_service."\">".$db_service."</option>\n";
	}
}
?>
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="reportmpay_exec.php" method="post" name="frmreport" id="frmreport">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการรายงาน - ยอดการใช้บริการ mPay</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                ...
                <td class="linemenu"><select name="service" id="service" style="width:300px;"><?php echo $productlist;?></select></td>
               </tr>
              <tr>
