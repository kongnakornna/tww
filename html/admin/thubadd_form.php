  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="thubadd_exec.php" method="post" name="frmthubadd" id="frmthubadd">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการข้อมูลกลาง - เพิ่มรายการ TWZpay Code</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">ใส่รหัสเริ่มต้น :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="text" name="startnum" id="startnum" maxlength="10" style="width:300px;" />*</td>
              </tr>
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">ใส่รหัสสิ้นสุด :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="text" name="endnum" id="endnum" maxlength="10" style="width:300px;" />*</td>
              </tr>
              </table></td></tr>
              <tr>
                <td><img src="images/spacer.gif" width="1" height="3" /></td>
