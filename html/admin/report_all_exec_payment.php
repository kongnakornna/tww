...
if ($RowsCheck>0) {
	...
	for ($t=0;$t<$RowsCheck;$t++) {
		 ...
		 $partnername = $partner->getnamebycode($db_pncode);
                  ...
                  if ($db_code == 'ES9996' || $db_code == 'ES9998' || $db_code == 'ES0018' || $db_code == 'ES1024' || $db_code == 'ES1023' || $db_code == 'ES1025' || $db_code == 'ES1026') 
                  $partnername = 'MPAY';
                 else if ($db_code == 'ES1028' || $db_code == 'ES1029')
                  $partnername = 'Myworld';
                 else
                  $partnername = 'WOP';
         ...
         if ($db_code == 'ES9997' || $db_code == 'ES9999') 
             $DataList .= "<tr bgcolor=\"".$iColor."\"><td align=\"right\" class=\"tblist\">".$iNum.".</td><td align=\"center\" class=\"tblist\">".$custcode."</td><td align=\"left\" class=\"tblist\">".$custname."</td><td align=\"center\" class=\"tblist\">".$db_email."</td><td align=\"left\" class=\"tblist\">".$custmobile."</td><td align=\"center\" class=\"tblist\">".$db_date."</td><td align=\"left\" class=\"tblist\">".$partnername."</td><td align=\"left\" class=\"tblist\">".$db_detail."</td><td align=\"left\" class=\"tblist\">".$db_ref2."</td><td align=\"center\" class=\"tblist\">".number_format($db_price,2,'.',',')."</td><td align=\"center\" class=\"tblist\">".number_format($db_charge,2,'.',',')."</td><td align=\"center\" class=\"tblist\"><strong>".number_format($db_total,2,'.',',')."</strong></td></tr>";
         else
            $DataList .= "<tr bgcolor=\"".$iColor."\"><td align=\"right\" class=\"tblist\">".$iNum.".</td><td align=\"center\" class=\"tblist\">".$custcode."</td><td align=\"left\" class=\"tblist\">".$custname."</td><td align=\"center\" class=\"tblist\">".$db_email."</td><td align=\"left\" class=\"tblist\">".$custmobile."</td><td align=\"center\" class=\"tblist\">".$db_date."</td><td align=\"left\" class=\"tblist\">".$partnername."</td><td align=\"left\" class=\"tblist\">".$db_detail."</td><td align=\"left\" class=\"tblist\">".$db_msisdn."</td><td align=\"center\" class=\"tblist\">".number_format($db_price,2,'.',',')."</td><td align=\"center\" class=\"tblist\">".number_format($db_charge,2,'.',',')."</td><td align=\"center\" class=\"tblist\"><strong>".number_format($db_total,2,'.',',')."</strong></td></tr>";
	}
}
$DataList .= "<tr bgcolor=\"#ffffff\"><td colspan=\"9\" align=\"right\" class=\"tblist\">ยอดรวม : </td><td align=\"center\" class=\"tblist\">".number_format($grandprice,2,'.',',')."</td><td align=\"center\" class=\"tblist\">".number_format($grandcharge,2,'.',',')."</td><td align=\"center\" class=\"tblist\"><strong>".number_format($grandtotal,2,'.',',')."</strong></td></tr>";
                  ...
                  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1">
				   <tr><td colspan="11" valign="middle" style="height:30px;"><b>วันที่ </b><?php echo $period;?></td></tr>
                    <tr>
                      ...
                      <td width="10%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>วันที่ทำรายการ</strong></td>
                      <td bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>ชื่อร้านค้า</strong></td>
                      <td width="11%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>รายการสินค้า</strong></td>
					  <td width="8%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>เบอร์ที่เติม</strong></td>	
