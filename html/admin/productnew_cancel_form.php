  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="productnew_cancel_exec.php" method="post" name="frmCancelProduct" id="frmCancelProduct">
		...
		<input type="hidden" id="catid" name="catid" value="<?php echo $param_catid;?>" />
          ...
          <tr>
            <td class="txttopicpage">จัดการรายการแอป - ไม่อนุมัติการขายแอป</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
			  ...
			  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                <tr>
                <td width="15%" align="right" valign="middle" class="barG">เหตุผล :&nbsp;</td>
                <td width="85%" class="linemenu"><textarea name="reason" id="reason" rows="15" style="width:670px;"></textarea></td>
              </tr>
			    </table>
