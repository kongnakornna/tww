	...
	if ($RowsCheck>0) {
		for ($t=0;$t<$RowsCheck;$t++) {
			...
			$data_com = "";
             ...
             $Grand_Total = $Grand_Total + $Data_Total;

			 $DataList .= "<tr bgcolor=\"".$iColor."\"><td align=\"center\" class=\"tblist\">".$member_type."</td><td class=\"txt1 tblist\">".$member_name."</td><td align=\"center\" class=\"tblist\">".$service_code."</td><td align=\"center\" class=\"tblist\">".$service_name."</td><td align=\"center\" class=\"tblist\">".$Data_TP."</td><td align=\"center\" class=\"tblist\">".$Data_TPF."</td><td align=\"center\" class=\"tblist\">".$Data_TPA."</td><td align=\"center\" class=\"tblist\">".$Data_TPFA."</td><td align=\"center\" class=\"tblist\">".$Data_Total."</td></tr>";

		}
	}
	unset($RowCheck);
	$DataList .= "<tr bgcolor=\"#ffffff\"><td colspan=\"4\" align=\"right\" class=\"tblist\"><b>Total :</b></td><td align=\"center\" class=\"tblist\">".$total_tp."</td><td align=\"center\" class=\"tblist\">".$total_tpf."</td><td align=\"center\" class=\"tblist\">".$total_tpa."</td><td align=\"center\" class=\"tblist\">".$total_tpfa."</td><td align=\"center\" class=\"tblist\">".$Grand_Total."</td></tr>";
    $DataList .= "<tr><td colspan=\"9\" height=\"15\">&nbsp;</td></tr>";
}
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">รายงานสรุปผลตอบแทนแต่ละบริการ แยกตามรหัสลูกค้า</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
