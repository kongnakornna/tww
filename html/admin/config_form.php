...
$msgdata = $config->getbycode($param_code);
?>
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="config_exec.php" method="post" name="frmconfig" id="frmconfig">
		<input type="hidden" id="code" name="code" value="<?php echo $param_code;?>" />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการข้อมูลกลาง - จัดการอีเมล์รับข้อมูล</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">ข้อมูล :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="text" name="msg" id="msg" maxlength="100" style="width:300px;" value="<?php echo $msgdata;?>" />*</td>
              </tr>
               </table></td></tr>
              <tr>
                <td><img src="images/spacer.gif" width="1" height="3" /></td>
