  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="changepass_exec.php" method="post" name="frmchnpass" id="frmchnpass">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ใช้งาน - เปลี่ยนรหัสผ่าน</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">รหัสผ่านเดิม :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="password" name="cname" id="cname" maxlength="15" style="width:300px;" />*</td>
              </tr>
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">รหัสผ่านใหม่ :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="password" name="npass1" id="npass1" maxlength="15" style="width:300px;" />*</td>
              </tr>
              <tr>
                <td width="15%" align="right" valign="middle" class="barG">รหัสผ่านใหม่ (อีกครั้ง) :&nbsp;</td>
                <td width="85%" class="linemenu"><input type="password" name="npass2" id="npass2" maxlength="15" style="width:300px;" />*</td>
              </tr>
              </table></td></tr>
              <tr>
                <td><img src="images/spacer.gif" width="1" height="3" /></td>
