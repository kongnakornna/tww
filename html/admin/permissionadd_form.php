  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="permissionadd_exec.php" method="post" name="frmAddPermission" id="frmAddPermission">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ใช้งาน - เพิ่มรหัสเมนู</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                ...
                <td class="linemenu"><input type="text" name="code" id="code" maxlength="3" style="width:300px;" />*</td>
                <td align="right" valign="middle" class="barG">ชื่อรหัสเมนู :&nbsp;</td>
                <td class="linemenu"><input type="text" name="title" id="title" style="width:300px;" />*</td>
              </tr>
