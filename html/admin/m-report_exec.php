...
$SqlCheck = "select * from tbl_member where (m_adddate>='".$startdate." 00:00:00' and m_adddate<='".$enddate." 59:59:59') and m_saleid='".$param_code."' order by m_adddate";
...
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
		 ...
		 $dbs_first_payment = $RowCheck['m_first_payment'];
		 ...
		 if ($dbs_first_payment=='0000-00-00') {
            $eAnswer = "ยังไม่เติม";
		 }else{
            $eAnswer = "เติมแล้ว";
		 }

		 $UserList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$dbs_fullname."</td><td align=\"center\" class=\"tblist\">".$eAnswer."</td></tr>";
	}
}
unset($RowCheck);
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">แสดงรายชื่อที่ทำการสมัครสมาชิก โดย S-Code</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
              <tr>
				...
				<br/><br/>      
				<form method="post" action="m-report_exec_csv.php" name="frmToCsv" id="frmToCsv" target="csv">
