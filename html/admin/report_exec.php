...
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
		 ...
		 $UserList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$db_saleid."</td><td align=\"left\" class=\"tblist\">".$vars_name."</td><td align=\"center\" class=\"tblist\">".$db_total."</td><td align=\"center\" class=\"tblist\">".$num."</td></tr>";
	}
}
unset($RowCheck);
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการรายงาน-ยอดสมัครสมาชิก โดย SD-Code</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
              <tr>
                  ...
                  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1">
				   <tr><td colspan="4" valign="middle" style="height:30px;"><b>วันที่ </b><?php echo $period;?></td></tr>
                    <tr>
                      ...
                      <td width="20%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>รหัส SD-Code</strong></td>
                      <td bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>ชื่อ SD-Code</strong></td>
				...
				<br/><br/>      
				<form method="post" action="report_exec_csv.php" name="frmToCsv" id="frmToCsv" target="csv">
