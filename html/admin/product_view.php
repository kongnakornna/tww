...
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
         ...
         if ($db_recommended=='Y') {
             $recomtext = '<a href=\'setrecoms.php?id='.$db_id.'&keyword='.$param_keyword.'&rec=N&page='.$param_page.'&catid='.$param_catid.'\'>น่าสนใจ</a>';
		 }else{
             $recomtext = '<a href=\'setrecoms.php?id='.$db_id.'&keyword='.$param_keyword.'&rec=Y&page='.$param_page.'&catid='.$param_catid.'\'>ปกติ</a>';
		 }
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">แนะนำร้านค้าที่ใช้ EasyCard ได้- แสดงรายการร้านค้า</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
              <tr>
                <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="60%" align="left" valign="top" class="txtsg">ค้นหาชื้อร้านค้า :</td>
                    <td width="40%" align="left" valign="top" class="txtsg">เลือกตามประเภทร้านค้า : </td>
                  </tr>
                  <tr>
                  ...
                  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1">
					...
					<td width="15%" bgcolor="#F5F5F5" class="tablehead tblist txt1"><strong>ประเภทร้านค้า</strong></td>
					<td bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>ชื่อร้านค้า</strong></td>
					<td width="17%" bgcolor="#F5F5F5" class="tablehead tblist txt1"><strong>ชื่อผู้ร่วมค้า </strong></td>
					<td width="10%" bgcolor="#F5F5F5" class="tablehead tblist txt1"><strong>ความน่าสนใจ</strong></td>
					<td width="10%" bgcolor="#F5F5F5" class="tablehead tblist txt1"><strong>สถานะ</strong></td>
