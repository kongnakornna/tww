...
$SqlGroup = "select tbl_mpaytrans.m_mobileno as mobileno from tbl_mpaytrans,tbl_member where (tbl_mpaytrans.m_mobileno=tbl_member.m_mobile) and (tbl_mpaytrans.m_date>='".$startdate." 00:00:00' and tbl_mpaytrans.m_date<='".$enddate." 59:59:59') and tbl_mpaytrans.m_confirmstatus='Y' $SqlService $SqlType $SqlCode group by tbl_mpaytrans.m_mobileno order by tbl_mpaytrans.m_mobileno";
...
if ($RowsGroup>0) {
	for ($t=0;$t<$RowsGroup;$t++) {
		 ...
		 $service_array[$t] = $RowGroup['mobileno'];
	}
}
...
for ($y=0;$y<count($service_array);$y++) {
	...
	$gtotal = "";
	$iNum = 0;
	$DataList .= "<tr><td width=\"2%\" height=\"25\" bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\"><strong>ลำดับ</strong></td><td width=\"5%\" bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\"><strong>รหัสลูกค้า</strong></td><td bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\"><strong>ชื่อลูกค้า</strong></td><td bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\"><strong>รหัสบริการ</strong></td><td bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\"><strong>ชื่อรายการ</strong></td><td bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\"><strong>วันที่ทำรายการ</strong></td><td bgcolor=\"#F5F5F5\" width=\"5%\" class=\"txt1 tblist tablehead\"><strong>รหัส TPA</strong></td><td bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\"><strong>ชื่อลูกค้า TPA</strong></td><td width=\"5%\" bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\"><strong>Product Amt</strong></td><td bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\" width=\"5%\"><strong>Fee Amt</strong></td><td bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\" width=\"5%\"><strong>Total Amt</strong></td><td bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\" width=\"5%\"><strong>TPF</strong></td><td bgcolor=\"#F5F5F5\" class=\"txt1 tblist tablehead\" width=\"5%\"><strong>TPF/A</strong></td></tr>";

	$SqlCheck = "select tbl_mpaytrans.m_id as id,tbl_mpaytrans.m_servicecode as servicecode,tbl_mpaytrans.m_tranid as tranid,tbl_mpaytrans.m_customerid as customerid,tbl_mpaytrans.m_inccustfee as inccustfee,tbl_mpaytrans.m_totalamt as totalamt,tbl_mpaytrans.m_mobileno as mobileno,tbl_mpaytrans.m_date as mdate,tbl_mpaytrans.m_productamt as productamt,tbl_mpaytrans.m_confirmstatus as confirmstatus,tbl_mpaytrans.m_confirmtransid as confirmtransid from tbl_mpaytrans,tbl_member where (tbl_mpaytrans.m_mobileno=tbl_member.m_mobile) and (tbl_mpaytrans.m_date>='".$startdate." 00:00:00' and tbl_mpaytrans.m_date<='".$enddate." 59:59:59') and tbl_mpaytrans.m_mobileno='".$service_array[$y]."' and tbl_mpaytrans.m_confirmstatus='Y' $SqlType $SqlService order by tbl_mpaytrans.m_id";
	...
	if ($RowsCheck>0) {
		for ($t=0;$t<$RowsCheck;$t++) {
			...
			$data_com = "";
			 ...
			 $DataList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$member_type."</td><td class=\"txt1 tblist\">".$member_name."</td><td align=\"center\" class=\"tblist\">".$service_code."</td><td align=\"center\" class=\"tblist\">".$service_name."</td><td align=\"center\" class=\"tblist\">".$db_paydate."</td><td align=\"center\" class=\"tblist\">&nbsp;</td><td align=\"center\" class=\"tblist\">&nbsp;</td><td align=\"center\" class=\"tblist\">".$db_productamt."</td><td align=\"center\" class=\"tblist\">".$db_inccustfee."</td><td align=\"center\" class=\"tblist\">".$db_totalamt."</td><td align=\"center\" class=\"tblist\">".$Data_TPF."</td><td align=\"center\" class=\"tblist\">".$Data_TPFA."</td></tr>";

		}
	}
	unset($RowCheck);
	$DataList .= "<tr bgcolor=\"#ffffff\"><td colspan=\"11\" align=\"right\" class=\"tblist\"><b>Total :</b></td><td align=\"center\" class=\"tblist\">".$total_tpf."</td><td align=\"center\" class=\"tblist\">".$total_tpfa."</td></tr>";
    $DataList .= "<tr><td colspan=\"13\" height=\"15\">&nbsp;</td></tr>";
}
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">แสดงรายงานสรุปผลตอบแทนแบบละเอียด แยกตามรหัสลูกค้า</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
