  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="phonebrandadd_exec.php" method="post" name="frmAddPhoneBrand" id="frmAddPhoneBrand">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ใช้งาน - เพิ่มยี่ห้อมือถือ</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
                ...
                <td width="85%" class="linemenu"><input type="text" name="title" id="title" maxlength="75" style="width:300px;" />*</td>
              </tr>
