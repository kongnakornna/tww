...
$memberdata = $permission->getdata($param_id);
for ($p=0;$p<count($memberdata);$p++) {
	  $db_id = stripslashes($memberdata[$p]['p_id']);
	  $db_code = stripslashes($memberdata[$p]['p_code']);
	  $db_title = stripslashes($memberdata[$p]['p_title']);	  
}
?>
  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="permissionedit_exec.php" method="post" name="frmAddPermission" id="frmAddPermission">
		<input type="hidden" id="id" name="id" value="<?php echo $param_id;?>" />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ใช้งาน - ปรับปรุงรหัสเมนู</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tr>
                <td align="right" valign="middle" class="barG">รหัสเมนู :&nbsp;</td>
                <td class="linemenu"><input type="text" name="code" id="code" maxlength="3" style="width:300px;" value="<?php echo $db_code;?>" />*</td>
                <td align="right" valign="middle" class="barG">ชื่อรหัสเมนู :&nbsp;</td>
                <td class="linemenu"><input type="text" name="title" id="title" style="width:300px;" value="<?php echo $db_title;?>" />*</td>
              </tr>
