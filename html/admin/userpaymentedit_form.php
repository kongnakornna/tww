  ...
  <tr>
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <form action="userpaymentedit_exec.php" method="post" name="frmUpdateUser" id="frmUpdateUser">
		  <input type="hidden" id="id" name="id" value="<?php echo $param_id;?>" />
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">จัดการผู้ใช้งาน - ปรับปรุงผู้ใช้งาน ระบบเติมเงิน</td>
          </tr>
          <tr>
