...
$SqlComCheck = "select * from tbl_phone_brand $SQLSearch order by p_id";
...
$SqlCheck = "select * from tbl_phone_brand $SQLSearch order by p_id desc limit $min,$maxrec";
...
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
         ...
         $totalModel = $product->totalmodel($db_id);
	     ...
	     $UserList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"left\" class=\"tblist\">".$db_title."</td><td align=\"center\" class=\"tblist\">".$totalModel."</td><td class=\"txt1 tblist\"><a href=\"phonebrandedit_form.php?id=".$db_id."\"><img src=\"images/edit.png\" width=\"16\" height=\"16\" border=\"0\" title=\"edit record\" /></a>&nbsp;&nbsp;<a href=\"phonebranddel_exec.php?id=$db_id\"  onclick=\"return confirmLink(this, 'ลบข้อมูล?')\"><img src=\"images/delete.png\" width=\"16\" height=\"16\" border=\"0\" title=\"delete record\"/></a></td></tr>";
	}
}
unset($RowCheck);
            ...
            <td>&nbsp;</td>
              ...
              <tr>
                <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top" class="txtsg">ค้นหาชื่อยี่ห้อมือถือ :</td>
                      <td align="left" valign="top" class="txtsg">&nbsp;</td>
                  </tr>
                  <tr>
                    <form action="phonebrand_view.php" method="post" name="frmsearchuser" id="frmsearchuser">
                  ...
                  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1">
                    <tr>
                      ...
                      <td bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>ชื่อยี่ห้อมือถือ</strong></td>
                      <td width="15%" bgcolor="#F5F5F5" class="tablehead tblist txt1"><strong>จำนวนรุ่น</strong></td>
