...
$paymentcode = $member->getcodebyemail($_SESSION['TWEmail']);
$barcode = "<img src=\"./photo/barcode/TWZ/".$paymentcode.".png\" border=\"0\" height=\"100\" />";
?>
...
<div id="wrapper">
   <?php include('_header.inc.php'); ?>
    ...
    <div id="pagenavi"><a href="mainpage.php">หน้าแรก</a> &raquo;&nbsp;ดูรหัส EasyCard</div>
    
    <div id="topicstyle1">ดูรหัส EasyCard</div>
    ...
    <div style="float:left; width:720px;">
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          <td width="20%" class="tabletopic" align="right">รหัส EasyCard</td>
          <td class="tablelist" align="left">&nbsp;&nbsp;<?php echo $paymentcode;?></td>
        </tr>
        <tr>
          <td width="20%" class="tabletopic" align="right">Barcode EasyCard</td>
          <td class="tablelist" align="left">&nbsp;&nbsp;<?php echo $barcode;?></td>
        </tr>
      </table>
    </div>
    </div>
