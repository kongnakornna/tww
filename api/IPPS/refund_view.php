...
if ($param_refid != '') {
$paymentdata = $payment->getpaymentdatabyrefcode($param_refid);
}
...
for ($p=$min;$p<$max;$p++) {
      ...
      $DataList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"txt1 tblist\">".$db_adddate."</td><td align=\"center\" class=\"tblist\">".$db_title."</td><td align=\"center\" class=\"tblist\">".$db_email."</td><td align=\"center\" class=\"tblist\">".$db_ref."</td><td align=\"center\" class=\"tblist\">".$db_price."</td><td align=\"center\" class=\"tblist\">".$db_total."</td><td align=\"center\" class=\"tblist\">".$db_txnid."</td><td class=\"txt1 tblist\"><a href=\"https://easycard.club/api/IPPS/ewalletcancel_temp.php?email=$db_email&refid=$db_ref&txnid=$db_txnid\" onclick=\"return confirmLink(this, 'Refund Transaction?')\"><img src=\"images/delete.png\" width=\"16\" height=\"16\" border=\"0\" title=\"refund transaction\"/></a></td></tr>";
}
            ...
            <td>&nbsp;</td>
              ...
              <tr>
                <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top" class="txtsg">ค้นหาด้วยเลข Reference ID :</td>
	              ...
	              <tr>
				<tr>
                <td align="right" valign="middle" class="barG">เลข Reference Id:&nbsp;</td>
