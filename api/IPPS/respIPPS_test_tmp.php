...
if ((trim($param_status))=='0101') {
     ...
     if ($result_array['status'] == '01')  {
         $payment->insert ($memberid,$tt_productid,'ส่วนลดจากการทำรายการเอง','D',$discount['discount_result_own'],'0',$discount['discount_result_own'],$param_refid,'','','N',$tt_email,'','TWZ','','1');  
         if ($discount['memberid_other'] != '')
  	     $payment->insert ($discount['memberid_other'],$tt_productid,'ส่วนลดจากผู้อื่นทำรายการ','D',$discount['discount_result_other'],'0',$discount['discount_result_other'],$param_refid,'','','N',$tt_email,'','TWZ','','1');  
     }
}
else{
