...
for ($p=0;$p<$max;$p++) {
      ...
      $DataList .= "<tr><td class=\"tablelist\" align=\"right\">".$iNum.".</td><td class=\"tablelist\" align=\"center\">".$db_date."</td><td class=\"tablelist\" align=\"left\">".$apptitle."</td><td class=\"tablelist\" align=\"right\">".$db_price." บ.&nbsp;&nbsp;</td><td class=\"tablelist\" align=\"center\">".$partnertitle."</td></tr>";
}
...
<div id="wrapper">
   <?php include('_header.inc.php'); ?>
    ...
    <div id="pagenavi"><a href="mainpage.php">หน้าแรก</a> &raquo;&nbsp;ดูรายการซื้อสินค้า</div>
    
    <div id="topicstyle1">ดูรายการซื้อสินค้า</div>
    ...
    <div style="float:left; width:720px;">
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="35%" class="tabletopic">ชื่อสินค้า</td>
          <td width="12%" class="tabletopic">ราคาที่ซื้อ</td>
          <td width="20%" class="tabletopic">ร้านที่ซื้อ</td>
        </tr>
		<?php echo $DataList;?>
      </table><br/>

	<form method="post" action="member_book_export.php" name="frmToCsv" id="frmToCsv" target="csv">
	  <table width="100%" border="0" cellspacing="1" cellpadding="0">
      <tr><td align="center"><?php echo $pagelist;?></td></tr>
      <tr><td align="left"><br/><input type="submit" name="btnSubmit" id="btnSubmit" value="นำออกในรูปแบบ csv" /></td></tr>
	  </table></form>
    </div>
    </div>
