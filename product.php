...
$dlist = "";
$sqltags = "";
$catdata = $content->getdatabycat($param_cat);
...
for ($c=0;$c<$catdata_count;$c++) {
	 ...
	 $freeapplist = $app->getdata ('',$param_cat,$param_sort);
	 ...
	 if ($freeapplistrows>0) {
		 ...
		 for ($f=0;$f<$freeapplistrows;$f++) {   
			 ...
			 $showimage = "<img src=\"./photo/gallery/".$fileimg[0]."\" width=\"173\" border=\"0\" class=\"cliplistthumb\" />";
			 $dlist .= "<div id=\"contentlist1\">".$showimage."<br /><div style=\"padding:8px;\"><a href=\"productdetail.php?id=".$db_id."\" class=\"cliplink\">".$db_title."</a><br /><img src=\"images/blank.gif\" width=\"1\" height=\"3\"><br />by <span class=\"ownerlink\">".$partnername."</span><br /><br /><div style=\"float:left; width:50px;\">&nbsp;</div></div></div>";
			 if ($fno==5) {
			   $dlist .= "<br clear=\"all\" />";
			   $fno = 1;
			 }else{
