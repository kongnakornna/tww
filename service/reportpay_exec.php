...
$SqlCheck = "select * from tbl_member,tbl_payment where (m_email=p_email) and (m_adddate>='".$startdate." 00:00:00' and m_adddate<='".$enddate." 59:59:59') and m_saleid='".$_SESSION['TWZUsername']."' and p_type='A' and p_status='1' order by m_adddate";
...
if ($RowsCheck>0) {
	for ($t=0;$t<$RowsCheck;$t++) {
		 ...
		 $UserList .= "<tr bgcolor=\"".$iColor."\"><td class=\"txt1 tblist\">".$iNum."</td><td align=\"center\" class=\"tblist\">".$dbs_fullname."</td><td align=\"center\" class=\"tblist\">".$dbs_price."</td></tr>";
	}
}
unset($RowCheck);

$UserList .= "<tr><td colspan=\"2\" align=\"right\" class=\"tblist\">ยอดรวม : </td><td align=\"center\" class=\"tblist\">".$totalprice."</td></tr>";
    ...
    <td class="warea frameoutside"><table width="100%" border="0" cellpadding="2" cellspacing="3">
      <tr>
        ...
        <td height="480" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td class="txttopicpage">แสดงรายชื่อที่ทำการสมัครสมาชิก โดย SD-Code</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
                  ...
                  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1">
				   <tr><td colspan="4" valign="middle" style="height:30px;"><b>วันที่ </b><?php echo $period;?></td></tr>
                    <tr>
                      ...
                      <td width="20%" bgcolor="#F5F5F5" class="txt1 tblist tablehead"><strong>จำนวนเงิน</strong></td>
					</tr>
                    <?php echo $UserList;?>
                </table>                
				
				<br/><br/>      
				<form method="post" action="reportpay_exec_csv.php" name="frmToCsv" id="frmToCsv" target="csv">
